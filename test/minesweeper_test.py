...
class TestMinesweeper(unittest.TestCase):
    def test_get_input_filename(self):
        infile = os.path.join(os.path.dirname(__file__), 'minesweeper_test_input/one_field.txt')
        game = Game(infile)
        game.infile = infile
    ...
    def test_mines(self):
        infile = os.path.join(os.path.dirname(__file__), 'minesweeper_test_input/one_mine.txt')
        game = Game(infile)
    ...
    def test_grid_text(self):
        ...
        infile = os.path.join(os.path.dirname(__file__), 'minesweeper_test_input/4_4_grid_2_mines.txt')
    ...
    def test_3_5_grid_3_mines(self):
        infile = os.path.join(os.path.dirname(__file__), 'minesweeper_test_input/3_5_grid_3_mines.txt')
        game = Game(infile)
